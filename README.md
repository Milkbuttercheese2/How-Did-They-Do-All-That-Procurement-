...
- 제도 69개가 공개되어 있습니다(등록·발주·공고·입찰·심사평가·계약이행·사후관리제재의 조달 업무 순서로 배열). 제도별 검증 상태는 상세 페이지 배지로 표시합니다.
...
- 접속 주소: <https://how-did-they-do-all-that-procurement.dali-n-narumi.workers.dev/>
